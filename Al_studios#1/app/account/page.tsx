  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom right, rgba(99, 102, 171, 0.8), rgba(0, 0, 0, 0.9)), url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/carl-raw-m3hn2Kn5Bns-unsplash.jpg-Gyflq2UWicTgxNkqBdNRYpFtjoEbw2.jpeg')`,
